...
function EmployeeCard({ data }) {
  return (
    <Link to={`/employees/${data.id}`} className="employee-card">
      <div className="employee-card__bio">
      ...
      <div className="employee-card__additional-info">
        ...
        <div className="employee-card__text">
          ...
          <div className="employee-card__inscription">
            Ответственный (-ая)
            {' '}
            <span className="employee-card__inscription_highlighted">{data.subordinatesCount}</span>
          </div>
        </div>
      </div>
    </Link>
